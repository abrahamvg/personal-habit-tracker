...
export const PRIORITY_CONFIG = {
  high: {
    ...
    textClass: 'text-priority-high-700',
    ...
    buttonInactiveClass: 'bg-white dark:bg-dark-card text-priority-high-600 border border-priority-high-200 dark:border-priority-high-800 hover:bg-priority-high-50 dark:hover:bg-priority-high-900/20',
  },
  medium: {
    label: 'Medium',
    emoji: '🟡',
    ...
    textClass: 'text-priority-medium-700',
    ...
    buttonInactiveClass: 'bg-white dark:bg-dark-card text-priority-medium-600 border border-priority-medium-200 dark:border-priority-medium-800 hover:bg-priority-medium-50 dark:hover:bg-priority-medium-900/20',
  },
  low: {
    label: 'Low',
    emoji: '🟢',
    ...
    textClass: 'text-priority-low-700',
    ...
    buttonInactiveClass: 'bg-white dark:bg-dark-card text-priority-low-600 border border-priority-low-200 dark:border-priority-low-800 hover:bg-priority-low-50 dark:hover:bg-priority-low-900/20',
  },
} as const;
